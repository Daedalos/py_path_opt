...
def run(N,D,dt,beta,x0):
    ...
    if x0=='start':
        ...
        init = np.loadtxt('initpaths.txt').reshape(N,D)
    else:
        init = x0.reshape(N,D)        
    ...
    print "Exit flag = ", rep.terminationtype, rep.iterationscount , " iters"
    print "Action = ", action(final,beta), "beta: ", beta
...
if __name__ == "__main__" :
    ...
    np.savetxt('test_anneal.txt', store)
